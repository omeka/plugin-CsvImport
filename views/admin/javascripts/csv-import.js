...
(function ($) {
    ...
    Omeka.CsvImport.updateImportOptions = function () {
        ...
        var fields = $('div.field').has('#automap_columns_names_to_elements, #item_type_id, #collection_id, #items_are_public, #items_are_featured, #identifier_elements, #column_delimiter, #element_delimiter, #tag_delimiter, #file_delimiter');
